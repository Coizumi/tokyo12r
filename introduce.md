...
timerは通常更新に加え、金曜22:10と土曜22:10に翌日分の予想を生成・デプロイする。土曜22:10の追加により、日曜開催分を前日夜に公開できる。通常更新は土曜/日曜/月曜/火曜の08:45から20:45まで、毎時15分と45分に実行する。全レース結果が確定済みで、公開生成物より新しい生成入力ファイルがない場合、後続更新は公式取得を行わず正常終了する。JRA公式取得時の既定待機時間は1.2秒とする。
